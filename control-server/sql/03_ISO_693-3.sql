-- create language codes tables

-- create table ISO_693-3
CREATE TABLE "bb_nomenclature"."ISO_639-3" (
...
-- create table ISO_693-3_Names
CREATE TABLE "bb_nomenclature"."ISO_639-3_Names" (
  Id             char(3)     NOT NULL,  -- The three-letter 639-3 identifier
...
-- create table ISO_693-3_Macrolanguages
CREATE TABLE "bb_nomenclature"."ISO_639-3_Macrolanguages" (
...
-- create table ISO_693-3_Retirements
CREATE TABLE "bb_nomenclature"."ISO_639-3_Retirements" (
  Id          char(3)      NOT NULL,     -- The three-letter 639-3 identifier
